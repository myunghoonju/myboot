...
import admin.config.auth.dto.OAuthAttributes;
import admin.config.auth.dto.SessionUser;
import admin.domain.user.User;
import admin.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		String registrationId  = userRequest.getClientRegistration().getRegistrationId(); // google or else?
